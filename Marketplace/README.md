...
This is the codebase to Build a Full Stack NFT Marketplace on Ethereum with Polygon
...
```sh
git clone https://github.com/datradito/Consensys-NFT-platform-POC.git

cd Consensys-NFT-platform-POC/Marketplace
